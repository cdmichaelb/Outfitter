	...
	for vBagIndex = vFirstBagIndex, vNumBags do
		...
		if vNumBagSlots > 0 then
			for vSlotIndex = 1, vNumBagSlots do
				...
				if vTexture.iconFileID and not vUsedTextures[vTexture] then
					table.insert(self.TextureList, vTexture.iconFileID)
					vUsedTextures[vTexture.iconFileID] = true
				end
			end
		end
	end
